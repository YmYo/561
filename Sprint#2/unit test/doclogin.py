...
def crawler(driver):
    driver.get("localhost/login-cus.html")
    ...
    # # test login function
    # Func_test.test_login(driver, withoutSignupTest, "czy", "123456")
    # sleep(1)
    ...
    logging.info("Now testing login function")
    # test login function
    Func_test.test_login(driver, withoutSignupTest, "wang", "123456")
    sleep(1)
    ...
    Func_test.test_userprofile(driver, "rc", "123456")
    sleep(1)
