...
<nav class="navbar clearHeader">
    <div class="col-12">
        <div class="navbar-header"> <a href="javascript:void(0);" class="bars"></a> <a class="navbar-brand" href="index.html">Hospital System</a> </div>
            ...
            <ul class="list">
                ...
                <li class="active open"><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-calendar-check"></i><span>Appointment</span> </a>
                    <ul class="ml-menu">
                        ...
                        <li class="active"><a href="book-appointment.php?username=<?php echo $username;?>">Book Appointment</a></li>
                    </ul>
                </li>
        ...
        <div class="row clearfix">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					...
					<form action="bookok.php?username=<?php echo $username;?>" method="post">
					<div class="body">
                        <div class="row clearfix">
                            <div class="col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" class="form-control" placeholder="First Name" require="" name=Fname>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-xs-12">
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-sm-12">
                                ...
                                <a href="index.php?username=<?php echo $username;?>" class="btn btn-raised">Cancel</a>
                            </div>
                        </div>
                    </div>
					</form>
