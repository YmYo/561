        ...
        <div class="menu">
            <ul class="list">
                ...
                <li class="active open"><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-calendar-check"></i><span>Appointment</span> </a>
                    <ul class="ml-menu">
                        <li class="active"><a href="doctor-schedule.php?username=<?php echo $username;?>">Doctor Schedule</a></li>
    ...
    <div class="container-fluid">
       <div class="block-header">
        ...
        <table align="center" class="table table-bordered table table-hover table table-striped table-condensed">
            ...
            <td width = "100" height="30"><strong>Service</strong></td>
            <td width = "200" height="30"><strong>Time</strong></td>
			<td width = "100" height="30"><strong>Email</strong></td>
            <td width = "100" height="30"><strong>Phone</strong></td>
            </tr>
			<?php foreach($rows as $key => $v) {?> 
			<tr align="center" valign="bottom" bgcolor="#FFFFFF">
				  <td height="30"><?php echo $v['alname'];?> ,<?php echo $v['afname'];?></td>
                  <td><?php echo $v['agender'];?></td>
				  <td><?php echo $v['service'];?></td>
                  <td><?php echo $v['adat'];?>,<?php echo $v['atim'];?></td>
				  <td><?php echo $v['aemail'];?></td>
                  <td><?php echo $v['atel'];?></td>
			<?php };?>
        </table>     
    </div>
</section>
