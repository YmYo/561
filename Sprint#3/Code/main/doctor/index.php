    ...
    <aside id="leftsidebar" class="sidebar"> 
        ...
        <div class="menu">
            <ul class="list">
                ...
                <li class="active open"><a href="index.php?username=<?php echo $username;?>"><i class="zmdi zmdi-home"></i><span>Dashboard</span></a></li>                                               
...
<section class="content patients">
    <div class="container-fluid">
        ...
        <table align="center" class="table table-bordered table table-hover table table-striped table-condensed">
            ...
            <td width = "100" height="30"><strong>Age</strong></td>
            <td width = "100" height="30" onClick="sortData()" data-sort='asc' class='head'><strong>Gender</strong></td>
            <td width = "300" height="30"><strong>Address</strong></td>
            <td width = "100" height="30"><strong>Phone</strong></td>
            </tr>
			<?php foreach($rows as $key => $v) {?> 
			<tr align="center" valign="bottom" bgcolor="#FFFFFF">
				  <td height="30"><?php echo $v['clname'];?> ,<?php echo $v['cfname'];?></td>
                  <td><?php echo $v['cage'];?></td>
                  <td><?php echo $v['cgender'];?></td>
                  <td><?php echo $v['cstreet'];?>,<?php echo $v['ccity'];?>,<?php echo $v['cstate'];?>,<?php echo $v['czip'];?></td>
