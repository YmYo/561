...
//if(checkUser($email)){
	...
	$result=$conn->sql($sql);
	if($result){
        echo "<script language=\"javascript\">alert('Book successful!');location.href='../main.php?username=$username'</script>";
    }
    else{
        echo "<script language=\"javascript\">alert('Book failed!');location.href='book.php?username=$username'</script>";
    }
    $conn->close();
//}
